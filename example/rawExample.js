const Huchash = require('..')
const levelup = require('levelup')
const memdown = require('memdown')

Huchash.prototype.verifySubmit = function (number, headerHash, nonce, cb) {
  var self = this
  console.log(number)
...
var huchash = new Huchash(cacheDB)

var header = Buffer('0e2887aa1a0668bf8254d1a6ae518927de99e3e5d7f30fd1f16096e2608fe05e', 'hex')

huchash.verifySubmit(35414, header, 'e360b6170c229d15', function (result) {
